                    ...
                    <div class="row rmv ml-auto mr-auto">
                            <div class="col-md-4 col-sm-6 col-lg-4 col-xl-4 col-xs-12">
                                ...
                                <div class="card wecare-card">
                                  ...
                                  <img class="card-img-top care-img" src="img/bg.jpg" style="height: 177px;" alt="Card image cap">
                                  <div class="card-body cls-h">
                                    <div class="card-text text-sm">Upload Photo</div>
                                    <input type="file" name="" style="margin-bottom: 2px;">
