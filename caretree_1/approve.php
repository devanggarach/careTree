...
<div class="row rmv ml-auto mr-auto">
    ...
    <?php
    $nid55=$_SESSION['n_id'];
    $sql= "SELECT l_name,l_land,l_mobile,c_id, u_id, n_id, p_id, quantity, req FROM login l join cart c on(l.l_id=c.u_id) WHERE n_id=$nid55 and req=1 GROUP BY u_id";
    ...
    <div class="col-md-3 col-sm-6 col-lg-3 col-xl-3 col-xs-12">
        ...
        <div class="card-body" style="background-color: #004e00;">
            ...
            <table class="table text-xb">
                ...
                $u_id1=$row['u_id'];
                $n_id1=$row['n_id'];
                $sql1= "SELECT i_name,i_price ,c_id, u_id, n_id, c.p_id, quantity, req FROM product p JOIN cart c ON(p.p_id=c.p_id) WHERE u_id=$u_id1 AND n_id=$n_id1 and req=1";
            ...
            <div class="card-text" style="margin-top: 10px; ">
                ...
                <div class="btn-toolbar justify-content-between">
                    <div class="btn-group">
                        ...
                        <input type="submit" name="approve" value="Approve" class="btn btn-outline-warning"> 
                    </div>
                    <div class="btn-group">
                        <input type="submit" name="reject" class="btn btn-outline-light" value="Reject"> 
                    </div>
                </div>
            </div>
        </div>
...
if (isset($_POST['approve'])) 
{
    ...
    $query="UPDATE cart SET req=2 WHERE u_id=$u_id11 and n_id=$n_id11";
...
if (isset($_POST['reject'])) 
{
    ...
    $query="DELETE FROM cart WHERE u_id=$u_id11 and n_id=$n_id11";
