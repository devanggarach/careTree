...
<?php include_once "header_trans.php"?>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="carousel-caption">
                            <h6>The care of the Earth is our most ancient and most worthy, and after all, our most pleasing responsibility.</h6>
                            <a href="#rescue"><button type="button" class="btn btn-success btn-sm btn-c">Care Now <i class="fas fa-plus-circle"></i></button></a>
                        </div>
                        <img class="d-block w-100 h-100" src="img/sld_bg1.png" alt="First slide">

                    </div>
                    <div class="carousel-item">
                        <div class="carousel-caption">
                            <h6>In a forest of a hundred thousand trees, no two leaves are alike. And no two journeys along the same path are alike.</h6>
                            <a href="#rescue"><button type="button" class="btn btn-success btn-sm btn-c">Care Now<i class="fas fa-plus-circle"></i></button></a>
                        </div>
                        <img class="d-block w-100 h-100" src="img/sld_bg2.png" alt="Second slide">

                    </div>
                    <div class="carousel-item">
                        <div class="carousel-caption">
                            <h6>You will find something more in woods than in books. Trees and stones will teach you that which you can never learn from masters.</h6>
                            <a href="#rescue"><button type="button" class="btn btn-success btn-sm btn-c">Care Now <i class="fas fa-plus-circle"></i></button></a>
                        </div>
                        <img class="d-block w-100 h-100" src="img/sld_bg3.png" alt="Third slide">
	    		...
	    		<div class="card">
				  <div class="card-body body-c">
				  	<div class="btn-toolbar deskor justify-content-between">
				    	...
				    	<div class="desk">
				    		<a href="request.php"><button type="button" class="btn btn-success btn-sm btn-g">
				    			Request now <i class="far fa-circle"></i><!-- <i class="fas fa-plus-circle"></i> -->
				    		</button></a>
				    	</div>
				  	</div>
				  	<div class="card text-default">
						...
						<div class="card-img-overlay">
							<h5 class="card-title">Neem(limbado)</h5>
							<p class="card-text">Neem leaf is used for leprosy, eye disorders, bloody nose, intestinal worms, stomach upset, skin ulcers, diseases of the heart and liver problems.</p>
					...
					<div class="card text-default">
						...
						<div class="card-img-overlay">
							<h5 class="card-title">Pinnata(karanja)</h5>
                            <p class="card-text">Leaves of Pongamia pinnata are digestive, laxative, antihelmintic and are good for diarrhea, leprosy and cough. Flowers are useful to quench dipsia in diabetes.</p>
                            <!-- <div class="bottom-b">Total Trees: 24510 by 289 Citizens</div> -->
						</div>
					</div>
					<div class="card text-default">
						...
						<div class="card-img-overlay">
							<h5 class="card-title">Ashoka(asopalav)</h5>
                            <p class="card-text">The Ashoka herb can naturally improve the skin's complexion. It helps in blood purification and prevention of further skin allergies.</p>
                            <!-- <div class="bottom-b">Total Trees: 24510 by 289 Citizens</div> -->
						</div>
					</div>
				  </div>
				...
				<div class="card">
				  <div class="card-body body-c">
				  	<div class="btn-toolbar deskor justify-content-between">
				    	...
				    	<div class="desk">
				    		<a href="https://twitter.com/smartcityrajkot?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor"><button type="button" class="btn btn-success btn-sm btn-g">
