...
<body style="background-color: #004e00;">
<?php include_once"ngo_header_trans_sign.php";?>
            <!-- onsubmit="return Js_f_login()" -->
            <form name="f_login" action="p_n_signup.php" method="POST"  class="register-form">
        ...
        <div class="txtb">
            <!-- <textarea rows="5" cols="24" name="l_pincode"></textarea> -->
          <input type="text" class="col-sm-12" name="l_address">
